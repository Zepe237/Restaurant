...
import 'package:restaurant/screens/detail/widget/food_quantity.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        SizedBox(
          ...
          children: [
            _buildIconText(
              Icons.access_time_filled_outlined , Colors.blue , food.waitTime
            ),
            _buildIconText(
        ...
        Text(food.about, 
        style: TextStyle(
          wordSpacing: 1.2,height: 1.5, fontSize: 16,
        ),
        )
        ],
      ),
